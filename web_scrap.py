...
class Rectangle:
    ...
    def cropper(self, other):
        ...
        # else:
        #     new_min_x, new_max_x = self.line_croper(other.line_y, self.line_x)
        #     new_min_y, new_max_y = self.line_croper(other.line_y, self.line_y)
...
importance_first = 5
importance_second = 6
re_1 = Rectangle(1, 1, 7, 5, importance_first, threshold)
re_2 = Rectangle(2, 2, 8, 5, importance_second, threshold)
